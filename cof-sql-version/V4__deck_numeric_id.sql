...
UPDATE cof_deck_pmv p SET deck_ref = d.id FROM cof_deck d WHERE p.deck_id = d.deck_id;

ALTER TABLE cof_card ADD COLUMN IF NOT EXISTS deck_ref BIGINT;
UPDATE cof_card c SET deck_ref = d.id FROM cof_deck d WHERE c.deck_id = d.deck_id;
