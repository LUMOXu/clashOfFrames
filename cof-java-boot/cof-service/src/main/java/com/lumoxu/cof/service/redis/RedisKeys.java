...
public final class RedisKeys {
    ...
    public static final String PLAYER_PRESENCE_PREFIX = "cof:player-presence:";
    ...
    public static String playerPresence(String clientId) {
        return PLAYER_PRESENCE_PREFIX + clientId;
    }
